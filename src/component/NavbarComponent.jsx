...
const NavbarComponent = () => {
  return (
    <Navbar className='bg-warning position-fixed top-0 start-0 end-0' expand='lg'>
        ...
        <Container>
            ...
            <Navbar.Collapse>
                <Nav>
                    ...
                    <Nav.Link href='#'>NavbarCollapse</Nav.Link>
                    ...
                    <NavDropdown title='NavDropdown'>
                        ...
                        <NavDropdown.Divider />
                        <NavDropdown.Item>NavDropdown.Item 3 after NavDropdown.Divider</NavDropdown.Item>
                    </NavDropdown>
                </Nav>
            </Navbar.Collapse>
        </Container>
